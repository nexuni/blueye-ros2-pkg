...
class BlueyeInterface(Node):
    ...
    def initialize_parameters(self):
        print("Initializing ROS parameters connection")
        self.rate = 10
        self.is_simulation = False  # to be read from param server ?
    ...
    def initialize_timer(self):
        ...
        self.timer = self.create_timer(
            self.timer_period, self.get_and_pub_rov_variables)
    ...
    def get_and_pub_rov_variables(self):
        ...
        if not self.is_simulation:
            ...
            pitch = float(list(self.drone.pose.values())[1]) # TODO: Check unit
